...
#macro HEALTH_BAR_BG_X1 UI_X2 - HEALTH_BAR_WIDTH - (HEALTH_BAR_PADDING * 2)
#macro HEALTH_BAR_BG_Y1 UI_Y1
#macro HEALTH_BAR_BG_X2 UI_X2 
#macro HEALTH_BAR_BG_Y2 UI_Y1 + HEALTH_BAR_HEIGHT + (HEALTH_BAR_PADDING * 2)

#macro HEALTH_BAR_FG_X HEALTH_BAR_BG_X1 + HEALTH_BAR_PADDING
#macro HEALTH_BAR_FG_Y HEALTH_BAR_BG_Y1 + HEALTH_BAR_PADDING
#endregion

#region Stamina Bar
#macro STAMINA_BAR_BG_X1 UI_X2 - HEALTH_BAR_WIDTH - (HEALTH_BAR_PADDING * 2)
#macro STAMINA_BAR_BG_Y1 UI_Y1
#macro STAMINA_BAR_BG_X2 UI_X2 
#macro STAMINA_BAR_BG_Y2 UI_Y1 + HEALTH_BAR_HEIGHT + (HEALTH_BAR_PADDING * 2)

#macro STAMINA_BAR_FG_X1 UI_X2 - HEALTH_BAR_WIDTH - (HEALTH_BAR_PADDING * 2)
#macro STAMINA_BAR_FG_Y1 UI_Y1
#macro STAMINA_BAR_FG_X2 UI_X2 
#macro STAMINA_BAR_FG_Y2 UI_Y1 + HEALTH_BAR_HEIGHT + (HEALTH_BAR_PADDING * 2)
#endregion

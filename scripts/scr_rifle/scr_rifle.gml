				...
				if (burst > 0)
					{
						...
						with (instance_create_layer(instance.x, instance.y, "enemies", obj_projectile, { sprite_index: spr_bullet, speed: 10, direction: _direction, image_angle: _direction })) lifetime = RIFLE_RANGE;
						instance_offset -= 3;
						clip -= 1
						burst--;

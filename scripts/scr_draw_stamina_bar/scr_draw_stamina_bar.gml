...
#macro STAMINA_BAR_BACKGROUND_X      (UI_X2 - UI_MARGIN - STAMINA_BAR_BACKGROUND_WIDTH)
#macro STAMINA_BAR_BACKGROUND_Y      (HEALTH_BAR_BACKGROUND_Y + HEALTH_BAR_BACKGROUND_HEIGHT + UI_MARGIN)
...
function draw_stamina_bar() {
	...
	if (DEBUG == true) {
		...
		draw_text_colour(
			STAMINA_BAR_BACKGROUND_X - UI_MARGIN, 

...
if instance_number(obj_basic_enemy) < 3 && spawn_cooldown == false {
	if !collision_rectangle(obj_player.x - 300,obj_player.y - 200,obj_player.x + 200,
		obj_player.y + 300,	obj_enemy_spawner, true, false)
	{
